...
from infrastructure.tinvest.sandbox_account_provider import TInvestSandboxAccountProvider
from infrastructure.tinvest.sandbox_order_executor import TInvestSandboxOrderExecutor
...
def main() -> None:
    ...
    limit_price = current_price * Decimal("0.50")

    placed_order = order_executor.place_limit_buy(
        account_id=sandbox_account_id,
